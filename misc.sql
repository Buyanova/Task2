...
Status_tovara nvarchar(100) not null
...
Sposob_dostavci nvarchar(100) not null,
Status_dostavci nvarchar(100) not null
Foreign key (Id_pokupatel) references Pokupatel(Id_pokupatel) on update cascade on delete cascade,
Foreign key (Id_zakaz) references Corzina(Id_zakaz) on update cascade on delete cascade
)
